...
var table = new Tabulator("#tabla_admin", {
    ...
    columns:[
        ...
        {title: "Primer Trimestre", columns:[ 
            {title:"Nota 1", field:"", editor:""},
            {title:"Nota 2", field:"", editor:""},
            {title:"Nota 3", field:"", editor:""},
            {title:"Con", field:"", editor:""},
            {title:"Promedio", field:"",headerVertical:true},
            {title:"Rec", field:"", editor:""},
            ],
        },
        
        {title: "Segundo Trimestre", columns:[ 
            {title:"Nota 4", field:"", editor:""},
            {title:"Nota 5", field:"", editor:""},
            {title:"Nota 6", field:"", editor:""},
            {title:"Con", field:"", editor:""},
            {title:"Promedio", field:"",headerVertical:true},
            {title:"Rec", field:"", editor:""},
            ],
        ...
        {title: "Tercer Trimestre", columns:[
            {title:"Nota 7", field:"", editor:""},
            {title:"Nota 8", field:"", editor:""},
            {title:"Nota 9", field:"", editor:""},
            {title:"Con", field:"", editor:""},
            {title:"Promedio", field:"",headerVertical:true},
            {title:"Rec", field:"", editor:""},
        ],
        ...
        {title: "DIC", field:"",headerVertical:true, editor:""},
        {title: "FEB", field:"",headerVertical:true, editor:""},
